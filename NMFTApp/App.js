...
const blobSasUrl = "https://jagathrescue.blob.core.windows.net/596e-backend?sp=racwdli&st=2022-03-02T18:39:33Z&se=2022-06-02T01:39:33Z&spr=https&sv=2020-08-04&sr=c&sig=7hdLnsjVUTPNmfzV2RJBkZdUP%2BrkVKrWlcEibwvKeIA%3D";
...
export default function App() {
  ...
  const getExampleResult = async (text) => {
    ...
    axios.post(example_worker_endpoint, {
      blob_key: blob_key
    }).then((response) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <br/>
      <Button
        onPress={async ()=>{getExampleResult(text)}}
